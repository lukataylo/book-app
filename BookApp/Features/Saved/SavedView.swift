...
/// The Saved tab — a visual gallery of every highlight and bookmark
/// across the user's library, presented as oversized "wisdom cards"
/// rather than a flat list. Each card pairs the quoted passage with the
/// originating book's cover so the source is glanceable.
///
/// Pre-seeded on first launch from each summary pack's curated passages,
